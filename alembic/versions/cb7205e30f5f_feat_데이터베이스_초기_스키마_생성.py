"""feat: 데이터베이스 초기 스키마 생성

Revision ID: cb7205e30f5f
Revises: 
Create Date: 2026-06-05 18:45:31.719543
...
def upgrade() -> None:
    ...
    sa.Column('gender', sa.Enum('M', 'F', name='genderenum'), nullable=True, comment='환자 성별'),
    ...
    sa.Column('hashed_password', sa.String(length=255), nullable=False, comment='평문 저장 x -> 해쉬화 된 비밀번호 저장'),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False, comment='유저 생성 일시'),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False, comment='진료 정보 등록 일시'),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False, comment='AI 폐렴 예측 결과 생성일시'),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False, comment='X-ray 이미지 등록 일시'),
    sa.ForeignKeyConstraint(['record_id'], ['medical_records.id'], ondelete='CASCADE'),
